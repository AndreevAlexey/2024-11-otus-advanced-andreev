...
5) На основе анализа журнала JFR найти проблемы в приложении и обосовать, как прийти к такому заключению о проблемах. В отчёт можно включать скрини JMC, ссылки на исходный код."
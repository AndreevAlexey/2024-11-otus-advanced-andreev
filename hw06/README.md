...
На основе результатов тестирования алгоритмов хэширования, я склоняюсь к выбору алгоритма MD5, т.к.,
он отличается самой высокой пропускной спосбностью по отношению к двум другим.
